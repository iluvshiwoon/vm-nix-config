...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "shuen"
    user-mail-address "sntcillian@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/kershuen/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/kershuen/bin" "/profile/bin" "/Users/kershuen/.npm-packages/bin" "/Users/kershuen/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
